    ...
    <div class="card-columns">
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-text">在这个平台上提交代码，不需要使用 <code>freopen</code>、<code>fstream</code> 控制文件输入输出，请直接使用标准输入输出。另外，可以在 <code>stderr</code> 中打印调试信息，但是调试信息不会被反馈。<code>main</code> 函数的返回值一定要为 <code>0</code>，否则测出结果也会认为你是出现了错误。</p>
		  ...
		  <p class="card-text">请不要提交恶意代码。不过……你大概提交了也会被我的程序解决掉？只会给你留下一个 Running 状态。</p>
		  <p class="card-text">技术支持：670171961@qq.com<br>Shared in GPLv2, source on github.</p>
        </div>
      </div>
